...
from model import BiModel, Model, MaskedNLLLoss, BiModelCRF
...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    for data in dataloader:
        ...
        if feature_type == "audio":
            ...
            log_prob, alpha, alpha_f, alpha_b, loss = model(torch.cat((textf,acouf),dim=-1), qmask,umask,labels_intput) # seq_len, batch, n_classes
...
model = BiModelCRF(D_m, D_g, D_p, D_e, D_h,
                n_classes=n_classes,
